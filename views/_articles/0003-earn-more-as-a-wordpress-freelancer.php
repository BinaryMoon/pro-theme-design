<p class="intro">WordPress Implmentors are a growing group of WordPress users who build sites for others. They are Freelancers who create sites for clients by buying themes, and then customizing them for their needs. In this article I have published some tips for earning more as a WordPress Freelancer.</p>

<h2>Charge More</h2>

<p>This is probably the simplest change you can make. So many people undervalue their time and knowledge. Now don't get me wrong - it's really hard to charge a lot when you start out - but it's worth it.</p>
...
<p>One of the problems with billing hourly for clients is that you, as the person being hired, have no incentive to work quickly. You will be paid more, the longer the job takes. This often means that clients ask for time sheets. You then have to tell clients what you've been doing, and sometimes explain, or even argue over why things take as long as they have. This is both stressful, and time consuming.</p>
...
<p>Learn to say 'no'. It's hard to say no to paying work - but there's a number of different types of people who will be hard to work with. They don't want to pay much - and their work invariably takes longer than you thought - as they pile on the 'small changes'.</p>
...
<h2>Focus on a Target Audience</h2>

<p>When you're starting out it's tempting to accept every job that comes your way. Making sites, big and small, for whoever asks. It's hard to turn people down when you don't have much work. However - it's a good idea to pick a target audience and focus on that audience strongly.</p>

<p>So what do I mean by a target audience? I mean to specialise. Spend some time working out what you are most interested in and then focus on that.</p>

<p>Don't try to be the best 'freelance WordPress Developer' be the best 'freelance WordPress Developer for comic book fans' (or other niche interest). It's a smaller audience but a lot easier to target a small focused group than targetting everyone.</p>

<p>Once you've completed a few jobs for the selected target audience then you can start to know where your audience hang out. What they want to do. How they like to work. Eventually you'll have a process, and a suite of plugins and themes that do exactly what your customers want.</p>

<p>Knowing your target audience well will also make advertising easier. You'll be able to focus on the places this audience hang out. It will mean you can learn their pain points and optimise your website accordingly. Different audiences need different things - and if you can become the 'go to' person for your specific niche then people will start recommending you. Eventually you'll own the niche.</p>

<p>Being specific is very important. Pick a tight focused niche. The broader the niche - the harder it will be to dominate. This may slow things down initially - but in the long term it should pay off massively.</p>
