<div class="wrapper text">
	...
	<p class="note icon"><?php draw_svg( 'alert-info', 'large' ); ?>From a technical perspective, the <a href="https://developer.wordpress.com/themes/">theme developer guidelines</a> on WordPress.com should be followed.</p>
	...
	<ul>
		...
		<li>Google Fonts/ default fonts. Never bundle fonts.</li>
