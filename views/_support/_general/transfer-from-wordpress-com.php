<p class="intro">Themes are not downloadable from WordPress.com - if you wish to use a theme on a self hosted website then you should buy one of our themes from <a href="https://creativemarket.com/BinaryMoon?u=BinaryMoon">Creative Market</a> or <a href="<?php echo path( 'theme-club/' ); ?>">join the theme club</a>.</p>
...
<p>WordPress.com offer a <a href="https://en.support.wordpress.com/guided-transfer/">Guide Transfer</a> service. This is a service that will help you, install WordPress, and move your website data to another web host. Please note that the Guided Transfer service does not include transferring premium themes.</p>
