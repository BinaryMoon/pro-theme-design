<p class="intro">Unfortunately themes are not downloadable from WordPress.com - if you wish to use a theme on a self hosted website then you should buy one of our themes from <a href="<?php echo path( 'themes/wordpress.org/' ); ?>">our site</a> or <a href="<?php echo path( 'theme-club/' ); ?>">join the theme club</a>.</p>
