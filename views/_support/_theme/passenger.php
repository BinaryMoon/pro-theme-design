...
<p>Passenger supports some of the available Post Formats, and styles each differently on the blog, archive, and search pages. Using the different formats will visually distinguish your types of content.</p>

<img src="<?php echo image_path( 'docs/passenger-post-formats.png' ); ?>" class="align-center" />
...
<p>Passenger has 2 optional sidebars. They will only display if they contain widgets.</p>

<ul>
    <li><strong>Footer Widgets</strong> - this displays in the footer and uses javascript to intelligently position the widgets to make sure they fit together nicely.</li>
...
<p>Passenger has a contributor custom page template. This template lists all of the contributors to your website sorted based on how many posts each person has published. Great for magazines and other multi-author blogs.</p>
