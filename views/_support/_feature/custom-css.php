...
<p>Custom CSS requires the <a href="<?php echo JETPACK; ?>">Jetpack plugin</a> to be installed and Activated. Once activated go to the Jetpack settings and enable the Custom CSS module. Once enabled you will be able to edit the CSS in the Appearance &rarr; Custom CSS page.</p>
