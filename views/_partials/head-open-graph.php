    ...
    <meta name="twitter:url" content="https://prothemedesign.com<?php echo path( ltrim( Flight::request()->url, '/' ) ); ?>">

    <!-- Open Graph data -->
    <meta property="og:title" content="<?php site_title(); ?>">
    <meta property="og:url" content="https://prothemedesign.com<?php echo path( ltrim( Flight::request()->url, '/' ) ); ?>">
