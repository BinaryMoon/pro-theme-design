...
?>
			<div class="wrapper map">
				...
				<div class="blurb blurb-ben">
					...
					<img id="ava-ben" class="avatar" src="<?php echo image_path( 'website/ava-ben.jpg' ); ?>" alt="">
					<h5>Ben Gillbanks</h5>
				...
				<div class="blurb blurb-darren">
					...
					<img id="ava-darren" class="pos avatar" src="<?php echo image_path( 'website/ava-darren.jpg' ); ?>" alt="">
					<h5>Darren Hoyt</h5>
