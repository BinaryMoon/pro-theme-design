...
?>
        <section class="wrapper">
            <div class="note message">
                ...
                <a href="<?php echo $theme[ 'url-wporg' ]; ?>" class="button fat positive event" data-event="getTheme"><i class="fa fa-download" aria-hidden="true"></i>Get <?php echo $theme['name']; ?> Now!</a>
<?php
