...
?>
    <body class="page-refund">
        ...
        <div class="wrapper text">
            ...
            <p class="intro">Really sorry to hear you're not happy with the theme - however we totally understand. We have a <strong>30 day refund policy for all themes purchased through Gumroad</strong>. <em>For other payment providers please see the <a href="<?php echo path( 'documentation/general/refunds/' ); ?>">refunds page</a></em>.</p>
            ...
            <form class="formspree form-contact" method="POST">
                ...
                <label>
                    <span>Your Gumroad Purchase Email Address</span>
