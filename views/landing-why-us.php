...
?>
    ...
    <body class="page-theme-club">
        ...
        <div class="wrapper text">
            ...
            <p>To save time cheaper themes often bundle third party scripts and plugins. However this means that the developers do not understand the code as well as they might. In addition - there have been some well publicised security flaws in a number of third party plugins that theme developers have bundled - which makes their customers more prone to security problems.</p>
            ...
            <p>The more complex code in these themes also means that if you were to hire someone to make changes, they would find it a lot harder to do so and so take longer, and cost you more in the long term.</p>
